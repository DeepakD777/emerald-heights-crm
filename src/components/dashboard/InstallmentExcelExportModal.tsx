...
import {
    exportInstallmentReportExcel,
} from "../../utils/exportInstallmentReportExcel";

import type {
    InstallmentExcelPropertyFilter,
} from "../../utils/exportInstallmentReportExcel";
...
interface InstallmentExcelExportModalProps {
    isOpen: boolean;
    onClose: () => void;
    bookings: any[];
}
...
function InstallmentExcelExportModal({
    isOpen,
    onClose,
    bookings,
}: InstallmentExcelExportModalProps) {
    ...
    const handleExport =
        async () => {
            ...
            try {
                ...
                await exportInstallmentReportExcel(
                    bookings,
                    {
                        propertyType,
                ...
                console.error(
                    "Installment Excel export error:",
                    error
                );

                alert(
                    "Failed to export installment report Excel."
                );
            ...
            <div className="w-full max-w-xl overflow-hidden rounded-2xl bg-white shadow-2xl">
                ...
                <div className="flex flex-col-reverse gap-3 border-t border-gray-200 bg-gray-50 px-5 py-4 sm:flex-row sm:justify-end sm:px-6">
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-60"
                    >
...
export default InstallmentExcelExportModal;